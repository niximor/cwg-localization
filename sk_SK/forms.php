...
$strings = array(
    ...
    "Field '%s̈́' contains invalid value." => "Položka '%s' obsahuje chybnú hodnotu.",
    "You are required to check the checkbox '%s'." => "Musíte začiarknuť '%s'.",
    "This form has already been submitted." => "Tento formulár bol už odoslaný.",
    "(step %d of %d)" => "(krok %d z %d)",
    "&lt; Previous" => "&lt; Predch.",
    "Next &gt;" => "Nasled. &gt;",
    "Number out of range in '%s'." => "Číslo v '%s' je mimo povolený rozsah.",
    "Up" => "Nahor",
    "Down" => "Nadol",
