...
$strings = array(
    ...
    "Collection entry is not counted in your stats until the xWG is published. When the xWG gets archived, your collection entries will be permanently removed." => "Záznam v zbierke nie je započítaný do štatistík, dokým nie je xWG uverejnené. Keď je xWG naopak archivované, záznam v zbierke je odstránený.",
    "This xWG is archived and is available only for viewing purpose. You cannot do any action with it." => "Toto xWG je archivované a je k dispozícii len na účely prezerania. Nemôžete s ním robiť žiadne úkony.",
    "Collection" => "Zbierka",
    "Year" => "Ročník",
    "Pieces" => "Ks",
    "Pieces:" => "Kusov:",
